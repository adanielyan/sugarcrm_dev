...
class OutcomeByDayDashlet extends DashletGenericChart
{
    ...
    public function display()
    {
        ...
        $sugarChart->data_set = $sugarChart->sortData($sugarChart->data_set, 'd', false, 'sales_stage', true, true);
    ...
    protected function constructQuery()
    {
        $query = "SELECT sales_stage,".
            db_convert('opportunities.date_closed','date_format',array("'%Y-%m-%d'"),array("'YYYY-MM-DD'"))." as m, ".
        ...
        $query .= " GROUP BY sales_stage,".
                        db_convert('opportunities.date_closed','date_format',array("'%Y-%m-%d'"),array("'YYYY-MM-DD'")) .
                    " ORDER BY m";
